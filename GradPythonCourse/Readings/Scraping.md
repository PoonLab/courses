...
```
Source generated by online web hosting services such as [WordPress](https://wordpress.org) are no better.  Here's a nice snippet from the [Village Voice] website hosted on WordPress:
```html
...
This is why Python modules like BeautifulSoup have become necessary.  
