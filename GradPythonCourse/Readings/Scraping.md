...
```
Source generated by online web hosting services such as [WordPress](http://wordpress.org) are no better.  Here's a nice snippet from a website hosted on WordPress:
```html
